...
export default function LifeInUkClient() {
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            name: "TestTutor - Life in UK Tests",
            description:
              "Comprehensive Life in UK practice tests covering British history, culture, government, and law. Prepare for your UK citizenship test with detailed explanations.",
            url: "https://testtutor.com/lifeInUk",
            sameAs: [
            ...
            offers: {
              ...
              price: "0",
              priceCurrency: "GBP",
              description: "Free Life in UK practice tests",
            },
            educationalCredentialAwarded: "Life in UK Test Preparation",
            hasOfferCatalog: {
              "@type": "OfferCatalog",
              name: "Life in UK Test Catalog",
              itemListElement: tests.map((test, index) => ({
                ...
                position: index + 1,
                url: `https://testtutor.com/test/${test.id}`,
              })),
            },
          }),
        }}
              ...
              <nav className="hidden md:flex items-center space-x-8">
                ...
                <div className="relative dropdown-container">
                  <button
                    ...
                    aria-expanded={showTestsDropdown}
                    aria-haspopup="true"
                  >
                    <span>Tests</span>
                    <svg
                ...
                <div className="relative dropdown-container">
                  <button
                    ...
                    className="flex items-center space-x-1 text-gray-700 hover:text-blue-600 transition-colors font-medium"
                    aria-expanded={showExamsDropdown}
                    aria-haspopup="true"
                  >
                    <span>Exams</span>
                    <svg
        ...
        <main className="container mx-auto px-4 py-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto mb-6">
              Prepare for your Life in the UK test with our comprehensive
              practice exams covering all aspects of British life, history, and
              culture
            </p>
            ...
            <div className="bg-white rounded-lg shadow-sm p-4 mb-4 max-w-2xl mx-auto">
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                ...
                <div className="relative dropdown-container">
                  ...
                  {testDropdownOpen && (
                    <div
                      className="absolute z-10 w-48 mt-1 bg-white border border-gray-300 rounded-lg shadow-lg"
                      role="listbox"
                    >
                      <div className="py-1">
                        {[
                          ...
                          <button
                            ...
                            role="option"
                            aria-selected={selectedTestType === option.value}
                          >
                            {option.label}
                          </button>
                        ))}
                      ...
                      <div className="py-1">
                        {[
                          ...
                          <button
                            ...
                            role="option"
                            aria-selected={selectedExamMode === option.value}
                          >
                            {option.label}
                          </button>
                        ))}
          ...
          <div className="bg-white rounded-lg shadow-sm p-6 mb-8">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <button
                ...
                aria-pressed={selectedCategory === "history"}
              >
              ...
              <button
                ...
                aria-pressed={selectedCategory === "government"}
              >
              ...
              <button
                ...
                aria-pressed={selectedCategory === "culture"}
              >
              ...
              <button
                ...
                aria-pressed={selectedCategory === "geography"}
              >
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                {filteredTests.map((test) => (
                  ...
                  >
                    ...
                    <Link
                      href={`/test/${test.id}`}
                      className="block w-full text-center px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2"
                    >
                      Start Test
                    </Link>
                  </article>
